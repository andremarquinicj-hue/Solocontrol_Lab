...
export default function HistoricoPage(){
 ...
 async function importNow(){
  ...
  try{
    ...
    setAll(updated);
    setMessage(`${preview.length} registros históricos importados com sucesso.`);
    setPreview([]);
